 ...
 * mengenai struktur data queues dengan pendekatan circular arrays.
 * 
 * @section Operations
 ...
 * 
 * @author Profil
 * - nama : Keisha Shendy Fadhillah Arrafli
 * - nim  : 20240140281
 * - kelas: F
 ...
 * @date 2025-06-23
 * 
 * @copyright Shendy@umy.ac.id (c) 2025
 * 
 */
...
public:
    ...
    void display() {
        ...
        if (FRONT_position <= REAR_position) {
            ...
            FRONT_position = 0;  // After reaching the end, wrap around to 0
